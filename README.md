...
I executed the queries with Python in the Jupyter Notebook file [View the notebook](CustomerAndProductAnalysis_QueryingSQLiteFromPyton.ipynb), illustrated some results and summerised the results. 
